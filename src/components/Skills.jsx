...
const skillsData = [
  {
    category: "Android",
    skills: [
      { name: "Java", src: "https://img.icons8.com/?size=96&id=GPfHz0SM85FX&format=gif", type: "img" },
      { name: "Kotlin", src: "https://cdnl.iconscout.com/lottie/premium/preview-watermark/kotlin-programming-language-6543310-5401030.mp4", type: "video" },
      { name: "XML", src: "https://img.icons8.com/?size=96&id=QsO1qiXCL8H2&format=gif", type: "img" },
      { name: "Android Studio", src: "https://cdnl.iconscout.com/lottie/free/thumb/free-android-4740777-3938339.mp4", type: "video" },
    ],
  },
  {
    category: "Backend",
    skills: [
      { name: "Node JS", src: "https://media.licdn.com/dms/image/D4D12AQGPsMj05z71VA/article-cover_image-shrink_600_2000/0/1693836846985?e=2147483647&v=beta&t=eqxVcd9LGvamjnWIcEXGZ8tYqUnShccB3vm07aQ1kHc", type: "img" },
      { name: "MongoDB", src: "https://assets-v2.lottiefiles.com/a/2a2a499e-116d-11ee-8f41-7f82227ba589/MIgBtJS610.gif", type: "img" },
      { name: "Express JS", src: "https://cdn.icon-icons.com/icons2/3914/PNG/512/express_logo_icon_248911.png", type: "img" },
      { name: "Firebase", src: "https://user-images.githubusercontent.com/74038190/238200431-3c16d4f2-b757-4c70-8f42-43d5dddd2c36.gif", type: "img" },
      {
        name:"SpringBoot",src:"https://process.fs.teachablecdn.com/ADNupMnWyR7kCWRvm76Laz/resize=width:705/https://cdn.filestackcontent.com/DPeL7gwTxidF8b3IzYZH",type:"img"
      },
      { name: "MySQL", src: "https://logowik.com/content/uploads/images/mysql8604.logowik.com.webp", type: "img" },
    ],
  },
  {
    category: "Frontend",
    skills: [
      { name: "React JS", src: "https://media0.giphy.com/media/RJzm826vu7WbJvBtxX/giphy.gif", type: "img" },
      { name: "JavaScript", src: "https://img.icons8.com/?size=96&id=tGvHBPJaKqEd&format=gif", type: "img" },
      { name: "CSS", src: "https://cdnl.iconscout.com/lottie/premium/preview-watermark/css-8654540-6897446.mp4", type: "video" },
      { name: "HTML", src: "https://img.icons8.com/?size=96&id=Lb0GijAhiD3r&format=gif", type: "img" },
      { name: "Bootstrap", src: "https://purecode.ai/blogs/wp-content/uploads/2023/12/giphy-6.gif", type: "img" },
      { name: "Tailwind", src: "https://cdnl.iconscout.com/lottie/premium/preview-watermark/tailwind-css-10875167-8814761.mp4", type: "video" },
    ],
  },
];
  ...
  return (
    <div className="flex flex-col text-white" id="Projects">
      <div className="flex flex-col items-center">
        <h1 className="p-2 m-3 mt-16 text-5xl font-bold">Skills</h1>
        <h4 className="p-2 text-2xl text-center">
          Here are some of my skills on which I have been working for the past year
        </h4>
      </div>
      <div className="flex flex-wrap items-center justify-center cardsDiv responsiveDiv">
        {skillsData.map((category) => (
          <div key={category.category} className="flex flex-col w-5/12 p-3 m-5 border border-white h-fit rounded-xl">
            <div className="flex items-center justify-center">
              <h1 className="text-3xl font-bold">{category.category}</h1>
            </div>
            <div className="flex flex-wrap items-center justify-center p-3">
              {category.skills.map((skill) => (
                <div key={skill.name} className="flex items-center m-2 border border-white rounded-lg w-fit">
                  {skill.type === "img" ? (
                    <img className="m-2 rounded-xl" src={skill.src} height="40" width="40" alt={skill.name} />
                  ) : (
                    <video loop autoPlay className="m-2 rounded-xl" src={skill.src} height="40" width="40"></video>
                  )}
                  <h1 className="m-2 text-xs md:text-xl">{skill.name}</h1>
                </div>
              ))}
            </div>
          </div>
